...
protected static function uc_ui_BodyPartFilterPanel BodyPartFilterPanel(class<uc_ui_BodyPartFilterPanel> _class,UiPanel _parent) 
{
...
private function uc_ui_FilterPanel CreateFilterMiniPanel(string _title, float _x, float _y, float _w, float _h, float _scale) 
{
...
private function uc_ui_FilterPanel CreateGenderPanel(float _x, float _y, float _w, float _h, float _scale) 
{
	local uc_ui_FilterPanel _panel;
...
private function uc_ui_FilterPanel CreateArmorTypePanel( float _x, float _y, float _w, float _h, float _scale) 
{
	local uc_ui_FilterPanel _panel;
...
private function uc_ui_FilterPanel CreateTechLevelPanel( float _x, float _y, float _w, float _h, float _scale) 
{
	local uc_ui_FilterPanel _panel;
	local bool _inCharPool;
...
private function uc_ui_FilterPanel CreateStylePanel( float _x, float _y, float _w, float _h, float _scale) 
{
	local uc_ui_FilterPanel _panel;
...
//======================================================================================================================
// '{' in separate line or defaultProperties will be ignored !
defaultProperties 
{
