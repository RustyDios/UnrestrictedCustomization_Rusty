...
protected static function uc_BodyPartFilter BodyPartFilter(	class<uc_BodyPartFilter> _class) 
{
...
{
	return class'X2BodyPartTemplateManager'.static.GetBodyPartTemplateManager().FindUberTemplate( class'uc_BodyPartUtil'.static.BodyPartTypeToString(_partType), _templateName );
}
